...
public class MiniMaxH3ReferencesExtension : Extension
{
    ...
    public override void OnInit()
    {
        ...
        StyleSheetFiles.Add("Assets/secourses_prompt_media.css");
